  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
            ...
            <span className='text-blue-500'> Talk Time</span>
            </h1>
            <form onSubmit={handleSubmit}>
                <div>
                    ...
                    <input type="text" placeholder='Shah Rukh Khan' className='w-full input input-bordered h-10' 
                ...
                <div>
                    ...
                    <input type="text" placeholder='shahrukhkhan' className='w-full input input-bordered h-10' 
...
/*
STARTER CODE FOR ABOVE SIGNUP PAGE
